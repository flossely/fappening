...
if ($subAction == "tease") {
    ...
    $htmltag = htmlentities("<a href='$subSrc'><img src='$subSrc' style='width:20%;position:relative;'></a> <a href='$objSrc'><img src='$objSrc' style='width:20%;position:relative;'></a><br>");
    echo $htmltag;
}
